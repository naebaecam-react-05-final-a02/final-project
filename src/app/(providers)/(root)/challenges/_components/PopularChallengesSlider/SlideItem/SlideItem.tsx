    ...
    <div className={SlideItemVariants({ pos })}>
      <div className="flex flex-col gap-3">
        <div className="flex gap-2">
          ...
          <h3 className="text-xl font-semibold">만보 걷기 챌린지</h3>
        </div>
      ...
      <div className="w-full flex flex-col gap-2">
        <div className="flex">
          <Bullet />
          <p className="text-[16px] font-semibold">만보 걸음 인증</p>
        </div>

        <p className="text-[12px] text-white/50 font-light">2024.07.31 ~ 2024.08.31</p>
